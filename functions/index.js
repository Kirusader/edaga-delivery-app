                        ...
                        <tr>
                          <td align="center">
                            ...
                            >
                              <img
                                align="center"
                                src="https://res.cloudinary.com/drnarknab/image/upload/v1715679261/Screenshot_157_bmk1gj.png"
                                alt=""
                                width="600"
                                height=""
                                    ...
                                    <tr>
                                      ...
                                      >
                                        <a
                                          ...
                                          >edagadeliveryservice@gmail.com</a
                                        >
                                      </td>
                                    </tr>
                                  </table>
...
exports.sendOrder = functions.https.onRequest((req, res) => {
  cors(req, res, () => {
    const {name, email, phone, cartData, orderId} = req.query;
    ...
    items.forEach((item) => {
      htmlContent += `<li>
          <p style="font-size:16px">Product purchased: ${item.description}</p>
